            ...
            @if ($total_page>1)
                ...
                @else  
                    @if ($current_page < 4)
                        ...
                        @endfor
                        <span> ...</span>
                        <div class="page"><a href="/{{$shop->shop_name}}/page/{{$total_page-1}}"><button>{{$total_page-1}}</button></a></div>
                        <div class="page"><a href="/{{$shop->shop_name}}/page/{{$total_page}}"><button>{{$total_page}}</button></a></div>
                        <div class="page-surf"><a href="/{{$shop->shop_name}}/page/{{$next_page}}"><button>>> </button></a></div>
                    @else
                        <div class="page-surf"><a href="/{{$shop->shop_name}}/page/{{$prev_page}}"><button><< </button></a></div>
                        <div class="page"><a href="/{{$shop->shop_name}}/page/1"><button>1</button></a></div>
                        <span> ...</span>
                        <div class="page"><a href="/{{$shop->shop_name}}/page/{{$current_page-1}}"><button>{{$current_page-1}}</button></a></div>
