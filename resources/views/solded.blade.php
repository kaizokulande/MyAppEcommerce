            ...
            <div class="stock-content">
                ...
                <div class="stock">
                    ...
                    <div id="st_table">
                        <table class="tab">
                            <tr>
                                <th><a class="col-sort" id="sort-pdate" data-order="desc" href="{!! route('sort_solded',['page'=>$current_page]) !!}">Dates</a></th>
                                <th>Picture</th>
                                <th><a class="col-sort" id="sort-name" data-order="desc" href="{!! route('sort_solded',['page'=>$current_page]) !!}">Articles</a></th>
                                <th><a class="col-sort" id="sort-size" data-order="desc" href="{!! route('sort_solded',['page'=>$current_page]) !!}">sizes</a></th>
                                <th><a class="col-sort" id="sort-color" data-order="desc" href="{!! route('sort_solded',['page'=>$current_page]) !!}">Color</a></th>
                                <th><a class="col-sort" id="sort-quantity" data-order="desc" href="{!! route('sort_solded',['page'=>$current_page]) !!}">Quantity</a></th>
                                <th><a class="col-sort" id="sort-price" data-order="desc" href="{!! route('sort_solded',['page'=>$current_page]) !!}">Prix yen</a></th>
                                <th>Delete</th>
